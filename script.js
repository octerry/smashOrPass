...
const smashList = document.getElementById('smash_list');
const passList = document.getElementById('pass_list');
...
function smashAdd() {
    ...
    newH2.innerText = thisName;
    smashList.appendChild(newH2);
} 

function passAdd() {
    const newH2 = document.createElement('h2');
    newH2.innerText = thisName;
    passList.appendChild(newH2);
}
